                    ...
                    <div className="row">
                            ...
                            <div className="single-product-item">
                                <div className="product-image">
                                    ...
                                    <Link to="/subcraving"><img className="product-img-style"
                                        src="/sevkin/assets/img/products/product-img-1.png" alt="" /></Link>
                                </div>
                                <h5>Masala Sev</h5>
                                <img className="rate-icon-style" src="/sevkin/assets/img/icon/star-checked.png" alt="" />
                                <img className="rate-icon-style" src="/sevkin/assets/img/icon/star-checked.png" alt="" />
                                <img className="rate-icon-style" src="/sevkin/assets/img/icon/star-checked.png" alt="" />
                                <img className="rate-icon-style" src="/sevkin/assets/img/icon/star-checked.png" alt="" />
                                <img className="rate-icon-style" src="/sevkin/assets/img/icon/star.png" alt="" />
                                ...
                                <a href="cart.html" target="_parent" className="cart-btn"><img className="icon-style"
                                    src="/sevkin/assets/img/icon/cart.png" alt="cart"></img> <small>Add to Cart</small></a>
                            </div>
                        </div>
                        <div className="col-lg-2 col-md-6 text-center">
                            <div className="single-product-item">
                                <div className="product-image">
                                    ...
                                    <Link to="/subcraving"><img className="product-img-style"
                                        src="/sevkin/assets/img/products/product-img-2.png" alt="" /></Link>
                                </div>
                                <h5>Ratlami Sev</h5>
                                <img className="rate-icon-style" src="/sevkin/assets/img/icon/star-checked.png" alt="" />
                                <img className="rate-icon-style" src="/sevkin/assets/img/icon/star-checked.png" alt="" />
                        ...
                        <div className="col-lg-2 col-md-6 offset-md-3 offset-lg-0 text-center">
                            <div className="single-product-item">
                                <div className="product-image">
                                    <Link to="/subcraving"><img className="product-img-style"
                                        src="/sevkin/assets/img/products/product-img-3.png" alt="" /></Link>
                                </div>
                                <h5>Aloo Bhujia</h5>
                                <img className="rate-icon-style" src="/sevkin/assets/img/icon/star-checked.png" alt="" />
                                <img className="rate-icon-style" src="/sevkin/assets/img/icon/star-checked.png" alt="" />
                        ...
                        <div className="col-lg-2 col-md-6 offset-md-3 offset-lg-0 text-center">
                            <div className="single-product-item">
                                <div className="product-image">
                                    ...
                                    <Link to="/subcraving"><img className="product-img-style"
                                        src="/sevkin/assets/img/products/product-img-4.png" alt="" /></Link>
                                </div>
                                <h5>Tomato Sev</h5>
                                <img className="rate-icon-style" src="/sevkin/assets/img/icon/star-checked.png" alt="" />
                                <img className="rate-icon-style" src="/sevkin/assets/img/icon/star-checked.png" alt="" />
                        ...
                        <div className="col-lg-2 col-md-6 offset-md-3 offset-lg-0 text-center">
                            <div className="single-product-item">
                                <div className="product-image">
                                    <Link to="/subcraving"><img className="product-img-style"
                                        src="/sevkin/assets/img/products/product-img-5.png" alt="" /></Link>
                                </div>
                                <h5>Garlic Sev</h5>
                                <img className="rate-icon-style" src="/sevkin/assets/img/icon/star-checked.png" alt="" />
                                <img className="rate-icon-style" src="/sevkin/assets/img/icon/star-checked.png" alt="" />
                        ...
                        <div className="col-lg-2 col-md-6 offset-md-3 offset-lg-0 text-center">
                            <div className="single-product-item">
                                <div className="product-image">
                                    ...
                                    <Link to="/subcraving"><img className="product-img-style"
                                        src="/sevkin/assets/img/products/product-img-6.png" alt="" /></Link>
                                </div>
                                <h5>Roasted Nuts</h5>
                                <img className="rate-icon-style" src="/sevkin/assets/img/icon/star-checked.png" alt="" />
                                <img className="rate-icon-style" src="/sevkin/assets/img/icon/star-checked.png" alt="" />
